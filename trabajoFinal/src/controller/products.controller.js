...
export default class ProductController {
    get = async(req, res, next) => {
        ...
        try {
            ...
            (products.hasNextPage == true ) ? nextLink = `https://ecommerce.up.railway.app/api/products/?limit=${limit}&page=${page+1}&query=${query}` : nextLink = null;
            (products.hasPrevPage == true ) ? prevLink = `https://ecommerce.up.railway.app/api/products/?limit=${limit}&page=${page-1}&query=${query}` : prevLink = null;
