...
export default class ViewController {
    get = async(req, res, next) => {
        ...
        try {
            ...
            (products.hasNextPage == true ) ? nextLink = `http://ecommerce.up.railway.app/?limit=${limit}&page=${page+1}&query=${query}` : nextLink = null;
            (products.hasPrevPage == true ) ? prevLink = `http://ecommerce.up.railway.app/?limit=${limit}&page=${page-1}&query=${query}` : prevLink = null;
